...
import { customImageUploadPlugin } from "./customImageUploaderAdapter.js";

import FixComposing from "./fixComposing";
...
const CUSTOM_IMAGE_CONFIG_NAME = "customUploadConfig";
...
Editor.defaultConfig = {
  ...
  [CUSTOM_IMAGE_CONFIG_NAME]: {
    uploadUrl: "http://localhost:5000/file/addFile",
    // interceptor: (reponse) => response
  },
  [CUSTOM_CONFIG_NAME]: {
    uploadUrl: "http://localhost:5000/file/addFile",
    debugLog: true, // show console
    ...
    //     data.append('url', response.data.url)
    //     this.xhr.send(data)
    //   })
    // },
  },
