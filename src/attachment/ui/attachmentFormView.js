...
import '../theme/attachmentForm.css'
...
export default class MediaFormView extends View {
  ...
  constructor(validators, locale) {
    ...
    this.saveButtonView.bind('isEnabled').to(this, 'fileURLInputValue', (value) => !!value)
    ...
    this.setTemplate({
      ...
      attributes: {
        class: ['ck', 'ck-attachment-form', 'ck-responsive-form'],
  ...
  _createUrlInput() {
    ...
    this._urlInputViewInfoDefault = t('请输入附件URL地址')
    this._urlInputViewInfoTip = '' //t( 'Tip: Paste the URL into the content to embed faster.' );

    labeledInput.label = t('附件地址')
    labeledInput.infoText = this._urlInputViewInfoDefault

    inputField.on('input', () => {
      // Display the tip text only when there is some value. Otherwise fall back to the default info text.
      labeledInput.infoText = inputField.element.value ? this._urlInputViewInfoTip : this._urlInputViewInfoDefault
      this.fileURLInputValue = inputField.element.value.trim()
    })
